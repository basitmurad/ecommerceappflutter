...
class MyAppTextTheme{
  ...
  static TextTheme lightTextTheme= TextTheme(
    ...
    labelLarge: TextStyle().copyWith(fontSize: 12  , fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
    labelMedium: TextStyle().copyWith(fontSize: 14  , fontWeight: FontWeight.w400, color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme= TextTheme(
    ...
    labelLarge: TextStyle().copyWith(fontSize: 12  , fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
    labelMedium: TextStyle().copyWith(fontSize: 14  , fontWeight: FontWeight.w400, color: Colors.white.withOpacity(0.5)),
